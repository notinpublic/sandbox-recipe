    ...
    <div>
      <div className={`${styles.parallax}`}>
        ...
        <div className={`${styles.hero}`}>
          <div className={`${styles.wrapper}`}>
            <h1 className={`${styles.hero__title}`}>
              <span></span>Letteralmente Epico
            </h1>
            <div className={`${styles.button_container}`}>
            <button className={`${styles.button}`}>Guarda</button>
            <button className={`${styles.button}`}>Ascolta</button>
            </div>
          </div>
        </div>

        <img className={`${styles.parallax__bg}`} src="assets/bg.jpg" alt="" />
        <img className={`${styles.parallax__dust}`} src="assets/dust.webp" alt="" />
        <img
        ...
        <img
          ...
          alt=""
        />
        <img className={`${styles.parallax__jax}`} src="assets/jax.webp" alt="" />
        <img className={`${styles.parallax__luna}`} src="assets/luna.webp" alt="" />
        <img className={`${styles.parallax__manny}`} src="assets/manny.webp" alt="" />
        {/* <img className={`${styles.parallax__rays}`} src="assets/rays.webp" alt="" /> */}
      </div>
